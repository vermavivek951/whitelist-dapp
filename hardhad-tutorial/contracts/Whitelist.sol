...
contract Whitelist {
	...
	//numAdderssesWhitelisted would be used to keep track of how many addresses have been whitelisted
	...
	**/
	...
	function addAddressToWhitelist() public {
		...
		//check if the numAddressWhitelisted < maxWhitelistedAddress, if not then throw an errror.
